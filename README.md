...
/**
 * Generates JSON schema files for inclusion in Swagger schemas for given Objection.js models
...
```
/**
 * Generates and saves into specified directory JSON schema files for inclusion in Swagger schemas for given Objection.js models
 * @param {Model|Model[]} modelParam - model(s) to generate schemas for
